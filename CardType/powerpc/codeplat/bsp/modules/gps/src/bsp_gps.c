...
u32 bsp_get_synsrc_configuration(u8 Value)
{
	...
	if (Value == 0)
	{
		...
		switch(g_Clock_Set_AllDate.gps_Type)
		{
			...
			case SYNC_SOURCE_ES: u32SynSrc |= SYNSRC_ES_MASK; break;
...
void syn_ch_to_1588v2(void)
{
	...
	printf("synsrc change to 1588...\n");
  	bsp_cpld_write_reg(CPLD_AFC_CTRL_REG,0x80);
}
...
u32 get_synsrc_mask(void)
{
	...
	u32SynSrcMask |= (SYNSRC_1PPS_TOD_MASK| SYNSRC_1588_MASK| SYNSRC_LOCAL_MASK|SYNSRC_ES_MASK);
