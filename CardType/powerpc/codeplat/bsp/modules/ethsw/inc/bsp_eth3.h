...
#define ETHSW_DELAY(a)         {vu32 _i_;  for (_i_ = 0; _i_ < 5 * (a); _i_++) {__asm(" sync");}}
...
#define SWITCH_MODE                    0x20U  /*  8b:Switch Mode Register */
...
#define LED_CONTROL_A                  0x24U  /* 16b:LED Control Register */
...
#define AGING_TIME_CTRL                0x0CU  /* 32b:Aging Time Control */
/* MIRROR功能设置寄存器 */
...
#define INGRESS_MIRROR_MAC         	   0x16U  /* 64b: */

#define EGRESS_MIRROR_CTRL             0x1CU  /* 16b:Egress Mirror Control Register */
#define EGRESS_MIRROR_MAC         	   0x20U  /* 64b: */
...
#define ARL_TABLE_SEARCH_MAC_RESULT1   0x40U  /* 64b:ARL Search MAC/VID Result Register01 */
#define ARL_TABLE_SEARCH_DATA_RESULT1  0x48U  /* 32b:ARL Search Result Register 1 */
...
#define PVLAN_PORT(n)                  (0x00U+4*(n))  /* 32b:Port-Based VLAN REGISTERS, Port n */
