...
/*#  define MY_ETSEC_NAME "MYmotetsec"*/
...
#if (defined(INCLUDE_ETSEC_VXB_MEND) || defined(INCLUDE_TSEC_VXB_END))
const struct hcfResource tsecVxbEnd0Resources[] = {
    ...
    { "phyAddr",        HCF_RES_INT,    { (void *)5 } },     /*phyAddr should be 5, set as 7 to assume running*/
    { "miiIfName",      HCF_RES_STRING, { (void *)ETSEC_NAME } },
...
#if (defined(INCLUDE_ETSEC_VXB_MEND) || defined(INCLUDE_TSEC_VXB_END))
    { EPIC_TSEC1TX_INT_VEC,  ETSEC_NAME, 0, 0 },
    { EPIC_TSEC1RX_INT_VEC,  ETSEC_NAME, 0, 1 },
    { EPIC_TSEC1ERR_INT_VEC, ETSEC_NAME, 0, 2 },
    { EPIC_TSEC2TX_INT_VEC,  ETSEC_NAME, 1, 0 },
    { EPIC_TSEC2RX_INT_VEC,  ETSEC_NAME, 1, 1 },
    { EPIC_TSEC2ERR_INT_VEC, ETSEC_NAME, 1, 2 },
    { EPIC_TSEC3TX_INT_VEC,  ETSEC_NAME, 2, 0 },
    { EPIC_TSEC3RX_INT_VEC,  ETSEC_NAME, 2, 1 },
    { EPIC_TSEC3ERR_INT_VEC, ETSEC_NAME, 2, 2 },
#endif
};
...
#if defined (INCLUDE_ETSEC_VXB_MEND) || defined (INCLUDE_TSEC_VXB_END)
    { ETSEC_NAME, 0, VXB_BUSID_PLB, 0, tsecVxbEnd0Num, tsecVxbEnd0Resources },
    { ETSEC_NAME, 1, VXB_BUSID_PLB, 0, tsecVxbEnd1Num, tsecVxbEnd1Resources },
    { ETSEC_NAME, 2, VXB_BUSID_PLB, 0, tsecVxbEnd2Num, tsecVxbEnd2Resources },
#ifdef INCLUDE_OPTIONAL_TSECS
    { ETSEC_NAME, 3, VXB_BUSID_PLB, 0, tsecVxbEnd3Num, tsecVxbEnd3Resources },
#endif
#endif
