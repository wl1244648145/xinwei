...
#define INCLUDE_VLAN_END


#define VLAN_END_LOAD_FUNC VlanEndLoad
IMPORT END_OBJ * VLAN_END_LOAD_FUNC();
#define VLAN_END_LOAD_STRING ""
...
#ifdef INCLUDE_VLAN_END
        {1, VLAN_END_LOAD_FUNC, VLAN_END_LOAD_STRING, 0, NULL, FALSE},   
#endif
