...
#define M85XX_GPIOCR(base)                    (CAST(VUINT32 *)((base) + 0xE0030)) /**14\15 \22, set 1**/
#define   M85XX_GPINDR(base)         (CAST(VUINT32 *)((base) + 0xE0050))  /***input**/
#define  M85XX_GPOUTDR(base)         (CAST(VUINT32 *)((base) + 0xE0040))/**output***/
#define  M85XX_EIVPR11(base)           (CAST(VUINT32 *)((base) + 0x50160))

#define _PPC_BUCSR_FI 0x200            /* Invalidate branch cache */
#define _PPC_BUCSR_E 0x1               /* Enable branch prediction */

#define INT_PRI_P0_GPP24_31    0// 48//11
#define INT_LVL_P0_GPP24_31      INT_PRI_P0_GPP24_31   
#define INT_VEC_P0_GPP24_31    11 //INT_LVL_P0_GPP24_31  




#define  M85XX_EIVRP(base)     (CAST(VUINT32 *)((base) + 0x50000))

#define  M85XX_EIDR0(base)     (CAST(VUINT32 *)((base) + 0x50010))
#ifdef __cplusplus
    }
#endif /* __cplusplus */
