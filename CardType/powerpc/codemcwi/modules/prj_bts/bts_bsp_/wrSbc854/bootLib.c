...
void bootParamsPrompt
	...
	switch (n)
	    ...
	    case 0:  i = promptParamBootDevice (strBootDevice, bp.bootDev, 
                                &bp.unitNum, sizeof (bp.bootDev)); 
	                  printf("\n");
	    break; 
	    case 1:  i = promptParamNum (strProcNum, &bp.procNum, FALSE);
	                 printf("\n");
	    break;
	    ...
	    case 9:  i = promptParamString (strFtpPwLong, bp.passwd,
				sizeof (bp.passwd));	
	               printf("\n");
	    break;
	    case 10: i = promptParamNum (strFlags, &bp.flags, TRUE);	
	                 printf("\n");
	    break;
...
//    int i;
#if 0
    if ((i = promptRead (buf, BOOT_FIELD_LEN)) != 0)
    return (i);	
