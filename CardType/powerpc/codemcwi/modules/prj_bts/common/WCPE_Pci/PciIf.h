...
#ifdef M_TGT_L2
#define PROXY_TID_NUM 13
#else
#define PROXY_TID_NUM 8
#endif

#define BUF_POOL_NUM  5
#define MAX_TX_BUF_SIZE   4096
const UINT16 PciTxBufSize[BUF_POOL_NUM]= { 256,   512, 1024, 2048, MAX_TX_BUF_SIZE};

const UINT16 PciTxBufNum[BUF_POOL_NUM] = {16000,2000,4000, 10460, 200 };  // must smaller than 16K
...
public:
    ...
    UINT32  GetBufAddr(UINT16 poolIndex, UINT16 bufIndex);
...
private:
    ...
    static const UINT32 EV_MSG_Q       = VXEV01;    
    ...
    UINT32 OutboundMsgPostFailCount;
