...
////CL3OamCommonRsp CommonRsp;
    ...
    //向ems返回应答消息
    CM_PostCommonRsp(M_TID_EMSAGENTTX, pTransaction->GetRequestTransId(), M_BTS_EMS_CARRIER_DATA_CFG_RSP, OAM_SUCCESS);    
...
bool CTaskCfg :: CM_BtsNeighborListHandoffCfgReq(CMessage &rMsg) //M_EMS_BTS_NEIGHBOR_LIST_HANDOFF_CFG_REQ
{
    ...
    CM_PostCommonRsp(M_TID_EMSAGENTTX, ReqMsg.GetTransactionId(), M_BTS_EMS_NEIGHBOR_LIST_HANDOFF_CFG_RSP, OAM_SUCCESS);
