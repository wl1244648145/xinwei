/*****************************************************************************
 * vxwk2pthread.h - declares the wrapper functions and data structures needed
 *                  to implement a VxWorks kernel API in a POSIX Threads
 *                  environment.
 *  
...
#define VXWK_TICK 10 /* milliseconds per VxWorks scheduler tick */

/*
**  Task Scheduling Priorities in VxWorks are higher as numbers decrease...
**  define the largest and smallest possible priority numbers.
*/
#define MIN_VXWK_PRIORITY 255
#define MAX_VXWK_PRIORITY 0
...
/*****************************************************************************
**  Control block for pthread wrapper for VxWorks task
*****************************************************************************/
typedef struct vxwk_pthread_ctl_blk
{
        /*
        ** Task ID for task
        */
